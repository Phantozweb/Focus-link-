...
- Family history is negative for keratoconus or other corneal ectasias.
- Systemic history is unremarkable.

**Examination (Left Eye):**
- **UCVA:** 20/80
- **BSCVA:** 20/40 with -1.50 / -4.50 x 075
- **Slit Lamp:** Clear cornea, no visible Vogt's striae or Fleischer ring. Deep and quiet anterior chamber.
- **Topography:** Shows inferior steepening, but the axis is atypical and the classic "kissing doves" pattern is not present. Pachymetry shows thinning inferiorly, but not as dramatic as expected for classic KC.

I've attached the corneal topography maps for review. I'm considering early keratoconus, but the presentation is atypical. I'm also thinking about Pellucid Marginal Degeneration, though the thinning is not strictly peripheral.

What are your thoughts on the differential diagnosis? What would be your next steps in management? Would you consider corneal cross-linking at this stage given the documented progression of astigmatism?

Any insights would be greatly appreciated.
`,
    media: [
      { type: 'image', url: 'https://picsum.photos/seed/topo1/600/400', caption: 'Corneal Topography - Axial Map' },
      { type: 'image', url: 'https://picsum.photos/seed/topo2/600/400', caption: 'Corneal Topography - Elevation Map' },
    ],
    mediaCount: 2,
    replies: 12,
    views: 156,
  ...
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://picsum.photos/seed/oct1/600/400', caption: 'Macular OCT' },
      { type: 'image', url: 'https://picsum.photos/seed/faf1/600/400', caption: 'Fundus Autofluorescence' },
    ],
    mediaCount: 2,
    replies: 21,
    views: 289,
