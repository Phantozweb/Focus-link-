...
const promptTemplate = ai.definePrompt({
  ...
  prompt: `You are an expert clinical educator in optometry. Your task is to generate a realistic, detailed, and educational clinical case study based on the provided topic.
