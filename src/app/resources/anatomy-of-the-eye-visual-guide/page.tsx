             ...
             <div className="bg-brand-bg">
                <div className="text-center max-w-3xl mx-auto py-12 px-4">
                    <h1 className="text-4xl font-bold text-slate-800 mb-2">Anatomy of the Eye: A Visual Guide</h1>
                     <p className="text-lg text-slate-600">A comprehensive study tool for optometry students and professionals, covering the complete anterior to posterior anatomy of the eye with detailed mind maps. This guide is designed to enhance understanding of ocular structures for clinical practice and academic success.</p>
                </div>
