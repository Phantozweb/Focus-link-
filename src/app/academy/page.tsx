                         ...
                         <Dialog defaultOpen>
                          ...
                          <DialogContent className="sm:max-w-2xl p-0">
                            ...
                            <div className="px-6 pb-6 max-h-[60vh] overflow-y-auto">
                                <div ref={answerCardRef} className="p-6 bg-slate-50/70 rounded-lg border border-slate-200">
                                    <div className="border-b pb-4 mb-4">
                                        <h3 className="text-sm font-semibold text-slate-500 mb-2">Your Question:</h3>
                                        <p className='text-slate-800 font-semibold'>{question}</p>
                                    </div>
                                    <div>
                                        ...
                                        <div className="prose prose-slate max-w-none prose-p:my-2 prose-headings:my-4 prose-ul:my-2"
                                            dangerouslySetInnerHTML={{ __html: answer }}
                                        />
                                    </div>
                                </div>
                            </div>
                            <DialogFooter className="px-6 py-4 bg-slate-50 border-t rounded-b-lg">
