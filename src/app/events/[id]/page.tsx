...
export async function generateMetadata(
  ...
  return {
    title: `${webinar.title} | Focus Links Events`,
    ...
    <>
      ...
      <div className="bg-muted/40">
        <div className="container mx-auto max-w-5xl py-12 px-4 sm:px-6 lg:px-8">
          <Link href="/events" className="inline-flex items-center text-sm font-medium text-muted-foreground hover:text-primary mb-6">
