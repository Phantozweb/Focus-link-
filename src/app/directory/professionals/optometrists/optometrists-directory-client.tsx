...
export function OptometristsDirectoryClient({ allUsers }: { allUsers: UserProfile[] }) {
  ...
  const handleSearch = () => {
    ...
    router.push(`/directory/professionals/optometrists?${queryString}`);
  };
  ...
  const clearFilters = () => {
    ...
    router.push(`/directory/professionals/optometrists`);
  };
      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <main className="lg:col-span-3">
            <div className="mb-6">
              <h1 className="text-3xl font-bold font-headline">Optometrist Directory</h1>
