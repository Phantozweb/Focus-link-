          ...
          <section>
            ...
            <div className="grid grid-cols-1 gap-6">
              {liveWebinars.map(webinar => (
                <Card key={webinar.id} className="group overflow-hidden rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
                ...
                {pastWebinars.map(webinar => (
                   <Card key={webinar.id} className="group overflow-hidden rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-muted-foreground text-sm mt-auto border-t pt-3">Originally aired: <WebinarTime dateTime={webinar.dateTime} format={{ dateOnly: true }} /></p>
