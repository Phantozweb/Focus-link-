...
export function GuidedQuestionnaire({ onComplete }: GuidedQuestionnaireProps) {
  ...
  const isNextDisabled = !data[currentQuestion.field as keyof typeof data];
        ...
        <div className="space-y-4">
          ...
          {currentQuestion.type === 'text' && (
            <Input
              ...
              value={data[currentQuestion.field as keyof typeof data] as string || ''}
              onChange={e => handleChange(currentQuestion.field as keyof typeof data, e.target.value)}
          ...
          {currentQuestion.type === 'select' && currentQuestion.options && (
             <Select 
                onValueChange={value => handleChange(currentQuestion.field as keyof typeof data, value)}
                value={data[currentQuestion.field as keyof typeof data] as string || ''}
             >
