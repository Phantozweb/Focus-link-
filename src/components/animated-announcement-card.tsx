...
export function AnimatedAnnouncementCard() {
  ...
  return (
    <div className="relative rounded-xl p-8 flex flex-col justify-between shadow-xl flex-grow h-full bg-gradient-to-br from-slate-700 to-slate-900 overflow-hidden">
